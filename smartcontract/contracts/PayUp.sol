...
contract PayUp {
    ...
    // map structs internally by wallet address
    ...
    function payRequest(uint256 _request) public payable {
        require(_request < requests[msg.sender].length, "Request non-existent");
        ...
        myRequests[_request] = myRequests[myRequests.length - 1]; // move request to end of array
        myRequests.pop();
    }
    ...
    // Get all historic transactions user hs been apart of
